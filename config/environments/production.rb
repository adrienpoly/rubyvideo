...
Rails.application.configure do
  ...
  # config.action_mailer.default_url_options = {host: "https://rubyvideo.dev"}
  # config.action_controller.default_url_options = {host: "https://rubyvideo.dev"}
  ...
  config.asset_host = "https://rubyvideo.dev"
