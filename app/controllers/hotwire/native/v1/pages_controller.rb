    ...
    module V1
      class PagesController < ApplicationController
        ...
        def home
          ...
          # @latest_talks = Talk.includes(:speakers, event: :organisation).where(id: home_page_cached_data[:latest_talk_ids])
          ...
          render json: {
            ...
            latest_talks: @latest_talks.as_json(include: {
              event: {include: :organisation},
              speakers: {only: [:id, :name, :slug]}
            }),
            latest_events: @latest_events.as_json(include: :organisation),
            active_speakers: @active_speakers.as_json
          }
        end
      end
    end
